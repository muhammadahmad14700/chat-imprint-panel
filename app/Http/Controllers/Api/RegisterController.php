...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        if(isset($provider) && $provider == "phone")
        {
            $namee      = strtolower(str_replace(' ', '',  $name));
            $email      = $namee.'-'.uniqid()."@imprint.com";
            
        }
        if(isset($provider) && $provider == "email")
        {
            $namee  = strtolower(str_replace(' ', '',  $name));
            $email  = $data['email'];
        }
        ...
        if (isset($data['provider']) && $data['provider'] == "phone")
        {
    ...
    */
    ...
    protected function registered(Request $request, $user)
    {
        ...
        return response()->json([
            ...
            //'data'    => ['user'=>$request->user(),'token_type' => "Bearer",'accessToken' => $accessToken]
        ]);
    }
